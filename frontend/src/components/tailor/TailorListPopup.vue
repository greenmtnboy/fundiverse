<template>
  ...
  <v-dialog v-model="dialog" max-width="500">
    ...
    <v-card title="Stock Settings">
      <v-card-text>
        <p class="pb-4">
          You can exclude a list of stocks entirely with the below toggle, or
          scale the weighting of all stocks in the list in the index by some
          percent. The default 100% would not change the weight in the index.
        </p>
        <v-select
          v-model="list"
          :items="indexKeys"
