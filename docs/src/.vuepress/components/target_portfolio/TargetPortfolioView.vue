<template>
    <v-card :title="`Holdings (${portfolio.holdings.length})`" theme="dark" class="sharp">
        ...
        <v-card-actions><v-btn @click="displayLength=displayLength+10">See more</v-btn></v-card-actions>
    </v-card>
</template>
<style>
.sharp {
